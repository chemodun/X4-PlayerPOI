...
![alt text](docs/images/poi_rename_in_space.png)
![alt text](docs/images/poi_renamed_in_space.png)
![alt text](docs/images/create_poi_on_map_at_any_point.png)
![alt text](docs/images/created_poi_at_point_on_map.png)
![alt text](docs/images/poi_context_menu_on_map.png)
![alt text](docs/images/poi_tab_in_property_owned.png)
![alt text](docs/images/poi_context_menu_on_tab.png)
![alt text](docs/images/poi_tab_after_self_destruct.png)
